...
k_neighbors_list = [42,41,40,39,38,37,36,35,34,33,32,31]
results = []
...
print(
    f"\nBest k_neighbors(SMOTENC-LR): {best_k} with Average Accuracy: {best_acc:.4f} and Average Balanced Accuracy: {best_balanced_acc:.4f}")
