...
for fold, (train_index, test_index) in enumerate(kf.split(X), 1):
    ...
    X_train_resampled, y_train_resampled = over_sampler.fit_resample(X_train_final, y_train)  # 或者使用 under_sampler
...
print(f"\nRandomOverSampling Average Accuracy: {mean_acc:.4f}")
print(f"RandomOverSampling Average Balanced Accuracy: {mean_bal_acc:.4f}")
